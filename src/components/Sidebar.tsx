      ...
      >
        ...
        <div className="border-t border-slate-700">
          <button
            ...
            title="API 설정"
            className="w-full flex items-center gap-2 px-4 py-3 text-sm text-slate-400 hover:bg-slate-700 hover:text-white transition-colors"
          >
            <span className="text-base">&#9881;</span>
            {!collapsed && <span>API 설정</span>}
          </button>
        </div>
      </aside>
